...
|----------|--------------|----------|
| `depth` | `1` | Глубина вложенных подразделений в ответе (1–5) |
| `include_employees` | `true` | Включать список сотрудников |
...
- Дочерние подразделения перепривязывает к родителю удаляемого (на уровень выше)
